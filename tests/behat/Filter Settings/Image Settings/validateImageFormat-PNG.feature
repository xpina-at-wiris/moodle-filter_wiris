...
I need to change the configuration
  ...
  @javascript
  Scenario: Add a MathML formula and check MathType renders an PNG image correctly with server side rendering
  ...
  @javascript
  Scenario: Add a MathML formula and check MathType renders an PNG image correctly with client side rendering
